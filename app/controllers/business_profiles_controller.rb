class BusinessProfilesController < ApplicationController
  ...
  private
    ...
    def business_profile_params
      params.require(:business_profile).permit(:name, :email, :phone, :tagline, :about, :url, :blog, :twitter, :facebook, :linkedin, :google, :github, :image, :slug, :employees, :hiring, :latitude, :longitude, :owner)
    end
end
